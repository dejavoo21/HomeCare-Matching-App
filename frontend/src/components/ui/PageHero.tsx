...
export default function PageHero({
  ...
  return (
    <div className={`rounded-3xl bg-gradient-to-r from-slate-950 via-sky-950 to-indigo-900 px-6 py-5 text-white shadow-xl ${className}`}>
      <div className={`grid items-start gap-5 ${rightContent ? 'xl:grid-cols-[minmax(0,1fr)_380px]' : ''}`}>
